...
<body>
    ...
    <div class="s-layout">
        ...
        <main class="s-layout__content">
            <br>
         <h1 style="font-size:32px;width:80%; background-color: brown;color:whitesmoke;text-align:center;">LIST OF TASKS IN THE WAREHOUSE</h1>
<br>
       ...
       for ($i=1; $i<=mysqli_num_rows($query1); $i++){
         $row = mysqli_fetch_array($query1);
            ...
            <tr>
               ...
               <td><a href="delete_stask.php?id=<?php echo $row['id'];?>"><i class="fa fa-trash" style="font-size:20px;padding:10px;" ></i></a></td>
