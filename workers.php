...
<body>
    ...
    <div class="s-layout">
        ...
        <main class="s-layout__content">
         <br>
         <h1 style="text-align: center;font-size: 42px; width:80%; height:50px; background-color: brown;color: whitesmoke;"> WORKERS MANAGEMENT </h1>
            <div class="col-s-6 col-6 main">
               
  
                <div class="col-3 col-s-3 lpan">
                 <a href="viewworkers.php" style="font-size:30px;">
                ...
                <div class="col-3 col-s-3 lpan">
                    <a href="addemp.php" style="font-size:30px;">
