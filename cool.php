...
$sql1 = "select * from store_type WHERE store_name='cool'";
...
<body>
    ...
    <div class="s-layout">
        ...
        <main class="s-layout__content">
            <br>
         <h1 style="font-size:32px;width:80%; background-color: brown;color:whitesmoke;text-align:center;">COOL STORE STATUS</h1>
<br>
