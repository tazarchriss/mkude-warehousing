...
$sql1 = "select * from service_requests where pick='yes'";
...
<body>
    ...
    <div class="s-layout">
        ...
        <main class="s-layout__content">
            <br>
         <h1 style="width: 50%; background-color: brown;color:whitesmoke;text-align:center;">LIST OF PICKING REQUESTS</h1>
<br>
...
if (mysqli_num_rows($query1) == 0){
   ?>
   <h1 style="color:green;text-align:center;">NO PICKING REQUEST AVAILABLE!</h1>
  <?php
  echo "<br>";
}
